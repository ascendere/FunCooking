...
const Screen3 = (props: any) => {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#7BDFF2' }}
      ...
      <TouchableOpacity onPress={() => props.navigation.navigate("Colection")}
        style={styles.button}>
        <Text style={styles.textButton}>VER CARTAS</Text></TouchableOpacity>
    </View>
  )
}
